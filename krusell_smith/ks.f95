! need to change the using_tauchen file to Ni =2, discretize markov of idio. shock to only 2 states
MODULE KSPARAM
    IMPLICIT NONE
    ...
    REAL(KIND=8), DIMENSION(2), PARAMETER:: EMP_STATE=(/0.824246284139049 , 1.21322961260848/)
    ! DROP: THE NUMBER OF PERIODS TO DROP INIT DEPENDENCE
    INTEGER, PARAMETER:: N=500, T=5000, DROP=500

    REAL(KIND=8), PARAMETER:: K_MIN=2.01, K_MAX=9.01 ! DEFINE SMALL K GRIDS
    REAL(KIND=8), PARAMETER:: AGG_K_MIN=2.01, AGG_K_MAX=9.01
    INTEGER, PARAMETER:: NZ=SIZE(PROD_SHOCK), NY=SIZE(EMP_STATE), NK=1000, NAK=25
...
MODULE KSRES
    ...
    REAL(KIND=8), DIMENSION(2):: INTERCEPT=(/0.195, 0.185/), SLOPE=(/0.8, 0.8/)
